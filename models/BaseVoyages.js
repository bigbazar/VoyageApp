const listVoyages = [
  ...
  },
  {
    ...
    description:
      "Québec est très différente de Montréal : la capitale provinciale a gardé un côté \"vieille Europe\" qui séduit les touristes en quête d'authenticité. Dans les rues du Vieux Québec, vous vous croirez dans une ville de province, digne d'un film de cape et d'épée. Fondée en 1608, Québec, dominée par l'imposante silhouette du Château Frontenac, est classée au Patrimoine mondial de l'Unesco. La vue depuis la terrasse Dufferin sur le Saint-Laurent est magnifique. Bref, Québec est une ville moyenne de 600 000 hab. bien tranquille et bien charmante.",
  },
  {
    id: 5,
    destination: 'Londres',
